# Base10 · Consensus VC Partner Cohort {{SITE_NAME}} DNA

Career-path DNA of partners at the 41 consensus firms. Reference for B10 partner-hire decisions. Internal Base10.

**Live URL**: `https://ade-B10.github.io/consensus-cohort-vc-partners/`
...
2. Enter the team password (saved in 1Password under "Base10 · Consensus VC Partner Cohort {{SITE_NAME}} DNA")
...
```bash
cd /Users/ade/Desktop/Urizen/consensus-cohort-vc-partners-deploy

# 1. Drop the updated unencrypted HTML into source/
cp /Users/ade/Desktop/Urizen/Consensus_Cohort_VC_Partners.html source/
...
# 3. Commit and push
git add index.html
git commit -m "Refresh Base10 · Consensus VC Partner Cohort {{SITE_NAME}} DNA ($(date +%Y-%m-%d))"
git push
```
