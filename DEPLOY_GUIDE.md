...
You're deploying to: `https://ade-B10.github.io/consensus-cohort-vc-partners/`
Password (save in 1Password under "Base10 · Consensus VC Partner Cohort {{SITE_NAME}} DNA"): `Base10Automation!`
...
2. Repository name: `consensus-cohort-vc-partners`
...
2. In Finder, open `/Users/ade/Desktop/Urizen/consensus-cohort-vc-partners-deploy/`
...
`https://github.com/ade-B10/consensus-cohort-vc-partners/settings/pages`
...
1. Under "Build and deployment":
   ...
   - **Branch**: `main` / `/ (root)`
2. Click **Save**
3. Wait ~30 seconds. The page will show: "Your site is live at `https://ade-B10.github.io/consensus-cohort-vc-partners/`"
...
- Ask in Claude to "update Base10 · Consensus VC Partner Cohort {{SITE_NAME}} DNA with [the new info]"
- Claude will edit `source/Consensus_Cohort_VC_Partners.html`, run `./update.sh`, and tell you the exact commit message
- You just commit + push (or paste the new `index.html` into GitHub web UI)

**DIY path:**
1. Update `source/Consensus_Cohort_VC_Partners.html` directly (or have Claude do it)
2. In Terminal: `cd ~/Desktop/Urizen/consensus-cohort-vc-partners-deploy && ./update.sh`
